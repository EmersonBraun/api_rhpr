...
*/
class PrivateFunctionsPeriodsRepository extends BaseRepository
{
    use ResponseTrait;
	...
	public function __construct( PrivateFunctionsPeriods $model )
	{
		$this->model = $model;
    }

    /**
     * Example of expecific action from PrivateFunctionsPeriodsRepositorie.
