...
*/
class DependentesinativoRepository extends BaseRepository
{
    use ResponseTrait;
	...
	public function __construct( Dependentesinativo $model )
	{
		$this->model = $model;
    }

    /**
     * Example of expecific action from DependentesinativoRepositorie.
