...
*/
class PrivateFunctionsRepository extends BaseRepository
{
    use ResponseTrait;
	...
	public function __construct( PrivateFunctions $model )
	{
		$this->model = $model;
    }

    /**
     * Example of expecific action from PrivateFunctionsRepositorie.
