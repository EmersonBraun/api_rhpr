...
class HistoricalPoliceController extends Controller
{
    ...
    * )
    */
    public function searchGet(HistoricalPoliceRequest $request)
    {
    ...
    *     tags={"historicalPolice"},
    *     path="api/v1/historicalPolice",
    *     description="A list with historicalPolice",
    *     @OA\Response(
    *         response=200,
    *         description="A list with historicalPolice",
    *     ),
    ...
    * )
    */
    public function searchPost(HistoricalPoliceRequest $request)
    {
