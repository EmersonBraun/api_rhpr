...
*/
class InactiveDependentsRepository extends BaseRepository
{
    use ResponseTrait;
	...
	public function __construct( InactiveDependents $model )
	{
		$this->model = $model;
    }

    /**
     * Example of expecific action from InactiveDependentsRepositorie.
