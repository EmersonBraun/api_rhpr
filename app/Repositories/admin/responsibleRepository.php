...
*/
class AdminresponsibleRepository extends BaseRepository
{
    use ResponseTrait;
	...
	public function __construct( Adminresponsible $model )
	{
		$this->model = $model;
    }

    /**
     * Example of expecific action from AdminresponsibleRepositorie.
