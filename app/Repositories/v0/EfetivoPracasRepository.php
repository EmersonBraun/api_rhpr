...
*/
class EfetivoPracasRepository extends BaseRepository
{
    use ResponseTrait;
	...
	public function __construct( EfetivoPracas $model )
	{
		$this->model = $model;
    }

    /**
     * Example of expecific action from EfetivoPracasRepositorie.
